...
// (3.1)Create the third tile layer that will be the background of map
...
// 2.2 Add a reference to the major earthquake data to the overlay object
let overlays = {
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  // Create style for the tectonic boundaries lines
  let tecStyle = {
    color: "#f05e1b",
    weight: 2
  }
  ...
  d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function(tecData) {
    L.geoJson(tecData, {
      ...
      onEachFeature: function(feature, layer){
        console.log(layer);
        layer.bindPopup("Tectonic Plates");
      }
    }).addTo(tectonics);
    tectonics.addTo(map);
  });
